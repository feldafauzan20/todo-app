...
class NotificationService {
  ...
  constructor() {
    ...
    if (typeof window !== "undefined") {
      ...
      // Setup audio context unlocking on any user interaction
  ...
  async playNotificationSound(): Promise<void> {
    ...
    try {
      ...
      try {
        ...
        console.log("🔇 Audio completely blocked - notification shown silently");
      }
  ...
  showOverdueNotification(
    ...
    console.log(`🔊 Attempting to play overdue sound for task: ${taskInfo.text}`);
    this.playNotificationSound().catch(() => {
      console.log("🔇 Audio not yet unlocked - notification shown without sound");
    });
