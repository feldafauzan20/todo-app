...
export default function Navbar() {
  ...
  // Updated scroll handler with offset
      ...
      <div className="container mx-auto px-6">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <button
              ...
              className="text-gray-700 hover:text-purple-600 hover:cursor-pointer transition"
            >
              Features
            </button>
            <button
            ...
            <button
              ...
              className="px-6 py-2 rounded-full bg-gradient-to-r from-purple-600 to-pink-600 text-white font-medium hover:opacity-90 transition hover:cursor-pointer"
            >
              Get Started
            </button>
          </div>
        ...
        >
          <div className="px-4 py-3 space-y-4">
            <button
              onClick={() => handleScrollTo("features")}
              className="block w-full text-left text-gray-700 hover:text-purple-600 transition py-2"
            >
              Features
            </button>
            <button
