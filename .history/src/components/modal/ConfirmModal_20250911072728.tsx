      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="relative bg-white md:bg-red-600 rounded-2xl shadow-xl p-6 pt-12 max-w-sm md:max-w-md w-full text-center"
          >
            {/* Gambar kucing */}
            <div className="absolute -top-23 md:-top-25 left-1/2 -translate-x-1/2">
              <Image
