        ...
        >
          ...
          >
            ...
            <div className="flex justify-center gap-3">
              <button
                onClick={onClose}
                className="px-4 py-2 rounded-xl text-pink-700 bg-gray-200 hover:bg-gray-300 transition hover:cursor-pointer"
              >
                Cancel
              </button>
              <button
                ...
                className="px-4 py-2 rounded-xl bg-pink-500 text-white hover:bg-pink-600 transition hover:cursor-pointer"
              >
                Yes!
              </button>
            </div>
