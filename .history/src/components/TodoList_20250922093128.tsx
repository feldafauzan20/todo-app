...
// Update TodoList component untuk menggunakan isOverdue function

// Tambahkan prop isOverdue ke TodoList
type Props = {
  ...
  isOverdue: (todo: Todo) => boolean; // Tambahkan prop ini
};
          ...
          <AnimatePresence>
            {todosArray.map((todo) => (
              ...
              >
                ...
                <div className="p-4 lg:hidden md:bg-red-600">
