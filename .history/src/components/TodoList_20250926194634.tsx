...
type Props = {
  ...
  remindedTasks: number[]; // ✅ NEW: Array of reminded task IDs
...
export default function TodoList({
  todos,
  remindedTasks, // ✅ NEW: Destructure remindedTasks prop
  removeTodo,
  toggleTodo,
  updateTodo,
  deleteAllTodos,
  ...
  // ✅ NEW: Debug log untuk reminded tasks
    ...
    <>
      ...
      <ul className="w-full space-y-3">
        {todosArray.length === 0 ? (
          ...
          <AnimatePresence>
            {todosArray.map((todo) => {
              // ✅ NEW: Check if this task is currently reminded
