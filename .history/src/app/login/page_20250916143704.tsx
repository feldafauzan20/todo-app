...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-pink-200">
      <div className="bg-white backdrop-blur-lg p-8 rounded-2xl shadow-xl w-96 space-y-8">
        <div className="text-center space-y-4">
          <h1 className="text-4xl font-bold text-pink-300">Welcome Back!</h1>
          <p className="text-pink-300/80">Please sign in to continue</p>
        </div>
