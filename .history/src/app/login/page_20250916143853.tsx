...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-400 to-pink-300">
      <div className="bg-white/30 backdrop-blur-md p-8 rounded-2xl shadow-xl w-96 space-y-8 border border-white/20">
