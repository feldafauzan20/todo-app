...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-pink-100">
      <div className="bg-white backdrop-blur-md p-8 rounded-2xl shadow-xl w-96 space-y-8 border border-white/20">
        {/* Add cat image */}
        <div className="relative w-32 h-32 mx-auto -mt-20 drop-shadow-xl">
          <Image
            src="/assets/illustrations/cat-login.webp"
