    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-50 via-pink-50 to-purple-100">
      ...
      <div className="relative h-screen overflow-hidden flex items-center justify-center text-center">
        ...
        <motion.div
          ...
          className="absolute top-20 left-20 w-[30rem] h-[30rem] bg-purple-300/40 rounded-full blur-[140px] mix-blend-multiply"
        />
        <motion.div
          style={{ x: springX, y: springY }}
          className="absolute bottom-20 right-32 w-[32rem] h-[32rem] bg-pink-300/40 rounded-full blur-[140px] mix-blend-multiply"
        />
      ...
      <div className="relative">
        ...
        >
          <path
            fill="#faf5ff"
            fillOpacity="1"
            d="M0,160L48,154.7C96,149,192,139,288,160C384,181,480,235,576,240C672,245,768,203,864,192C960,181,1056,203,1152,208C1248,213,1344,203,1392,197.3L1440,192L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z"
          ></path>
        </svg>
      </div>
