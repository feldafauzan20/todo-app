...
import { LuCheckCircle, LuEdit3, LuListTodo, LuSmartphone } from "react-icons/lu";
  ...
  const features = [
    {
      ...
      description: "Easily add, edit, and organize your daily tasks in one place"
    },
    {
      icon: <LuCheckCircle className="w-8 h-8 text-blue-600" />,
      title: "Track Progress",
      description: "Mark tasks as complete and track your daily achievements"
    },
    {
      icon: <LuEdit3 className="w-8 h-8 text-blue-600" />,
      title: "Quick Edit",
