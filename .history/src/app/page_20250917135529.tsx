    ...
    <div className="min-h-screen bg-pink-100">
      ...
      <div className="container mx-auto px-4 py-20">
        <div className="flex flex-col items-center text-center space-y-8">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-teal-800 leading-tight">
            Manage Tasks Better
          </h1>

          <p className="text-lg md:text-xl text-teal-700/80 max-w-2xl">
          ...
          <button
            ...
            className="bg-teal-600 text-white px-8 py-3 rounded-lg text-lg font-medium 
                     hover:bg-teal-700 transition-colors shadow-lg hover:shadow-xl"
          >
            Get Started
          </button>
        </div>
          ...
          {features.map((feature, index) => (
            <div
              ...
              className="bg-white/70 backdrop-blur-sm p-6 rounded-xl shadow-sm 
                       hover:shadow-md transition-shadow border border-teal-100"
            >
              <div className="flex flex-col items-center text-center space-y-4">
                ...
                <p className="text-teal-700/70">{feature.description}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      <div className="container mx-auto px-4 py-16 mb-8">
        <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-8 md:p-12 
                      border border-teal-100 shadow-lg">
          <h2 className="text-3xl md:text-4xl font-bold text-center text-teal-800 mb-8">
            Boost Your Productivity
          </h2>
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="space-y-6">
              <p className="text-lg text-teal-700/80">Our todo app helps you:</p>
              <ul className="space-y-4">
                <li className="flex items-center space-x-3">
                  <LuCheck className="w-6 h-6 text-teal-600" />
