...
export const useReminderManager = (
  ...
  console.log(`[REMINDER DEBUG] useReminderManager called with:`, { todosCount: todos.length, showToast: !!showToast });
  ...
  const clearReminderEffect = (todoId: number) => {
    console.log(`[REMINDER DEBUG] Manually clearing reminder effect for task ${todoId}`);

    setRemindedTasks((prev) => {
      const newSet = new Set(prev);
      newSet.delete(todoId);
      console.log(`[REMINDER DEBUG] Updated remindedTasks:`, Array.from(newSet));
      return newSet;
    });
  ...
  const addRemindedTask = (todoId: number) => {
    ...
    setRemindedTasks((prev) => {
      ...
      console.log(`[REMINDER DEBUG] Updated remindedTasks after adding:`, Array.from(newSet));
      return newSet;
    });
      ...
      todos.forEach((todo) => {
        if (!todo.is_done && todo.reminder) {
          ...
          try {
            ...
            console.log(`[REMINDER DEBUG] Is valid date:`, !isNaN(utcTime.getTime()));
            ...
            console.log(`[REMINDER DEBUG] Current time:`, now.toISOString());
            console.log(`[REMINDER DEBUG] Reminder time:`, utcTime.toISOString());
  ...
  console.log(`[REMINDER DEBUG] Hook return - remindedTasks:`, Array.from(remindedTasks));
