// hooks/useReminderManager.ts - BETTER timezone handling
    ...
    const scheduleReminders = () => {
      ...
      todos.forEach((todo) => {
        if (
          ...
          // ✅ DIFFERENT APPROACH: Parse as local time instead of UTC
          const reminderTimeString = todo.reminder;

          // Create date in local timezone (not UTC)
          const reminderTime = new Date(reminderTimeString.replace("Z", ""));
