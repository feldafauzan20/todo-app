// hooks/useReminderManager.ts - REMOVE double timezone conversion
    ...
    const scheduleReminders = () => {
      ...
      todos.forEach((todo) => {
        if (
          ...
          // ✅ FIX: Simple parsing tanpa double timezone conversion
          ...
          console.log(
            `Reminder time (local): ${reminderTime.toLocaleString()}`
          );
